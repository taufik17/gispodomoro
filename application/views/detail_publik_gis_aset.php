									...
									<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="carousel-item active">
												<img class="d-block w-100" src="<?= base_url(); ?>assets/foto_aset/<?= $foto1 ?>" alt="First slide">
											</div>
											...
											<div class="carousel-item">
												<img class="d-block w-100" src="<?= base_url(); ?>assets/foto_aset/<?= $i->foto ?>" alt="First slide">
											</div>
											<?php } ?>
										</div>

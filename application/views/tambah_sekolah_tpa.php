	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<section class="col-lg-5 connectedSortable">
              ...
              <!-- /.card-header -->
							<form class="form-horizontal" method="post" action="<?= base_url(); ?>manajemen_sekolah_tpa/simpan" enctype="multipart/form-data">
                <div class="card-body">

                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                      <input type="text" name="nama" class="form-control" placeholder="Nama Sekolah / TPA" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="kepsek" class="form-control" placeholder="Kepala Sekolah / Pengurus" required>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
											<input type="file" class="dropify" name="foto_sekolah_tpa" data-height="80" required>

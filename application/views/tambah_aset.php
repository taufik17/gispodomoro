	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="card-info">
					<div class="card-header">
						<h3 class="card-title">
							...
							Piliha Lokasi Tempat Aset Pekon
						</h3>
					</div><!-- /.card-header -->
					<div>
			...
			<section class="col-lg-5 connectedSortable">
              ...
              <!-- /.card-header -->
							<form class="form-horizontal" method="post" action="<?= base_url(); ?>manajemen_aset_pekon/simpan" enctype="multipart/form-data">
                <div class="card-body">

                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                      <input type="text" name="nama" class="form-control" placeholder="Nama Aset Bangunan / Tempat" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
											<input type="file" class="dropify" name="foto_aset" data-height="80" required>

	...
	$.getJSON(base_url+"gis_pt/pt_json", function(data){
		$.each(data, function(i, field){
			...
			bangunanMarker = L.marker([v_lat, v_long],{icon:icon_pt})
				...
				+ "<a href='<?= base_url() ?>gis_pt/detail/"+data[i].id_pt+"'> <img src='<?= base_url() ?>assets/foto_pt/"+data[i].foto+"' height='180px' width='230px'/></a>"
				+ "<div style='width:100%; text-align:center; margin-top:10px;'><a href='<?= base_url() ?>gis_pt/detail/"+data[i].id_pt+"'> DETAIL </a></div>")
	...
	$.getJSON(base_url+"gis_tempat_ibadah/ibadah_json", function(data){
		$.each(data, function(i, field){
			...
			bangunanMarker = L.marker([v_lat, v_long],{icon:icon_ibadah})
				...
				+ "<a href='<?= base_url() ?>gis_tempat_ibadah/detail/"+data[i].id_ibadah+"'> <img src='<?= base_url() ?>assets/foto_ibadah/"+data[i].foto+"' height='180px' width='230px'/></a>"
				+ "<div style='width:100%; text-align:center; margin-top:10px;'><a href='<?= base_url() ?>gis_tempat_ibadah/detail/"+data[i].id_ibadah+"'> DETAIL </a></div>")

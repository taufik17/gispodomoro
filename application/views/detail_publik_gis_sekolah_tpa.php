			...
			<div class="row">
				...
				<section class="col-lg-6 connectedSortable" style="margin-bottom: 20px;">
					...
					<div class="card-info">
						...
						<div>
							<section class="col-lg-12 lebar_detail">
								<div id="map"></div>
									...
									<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										...
										<div class="carousel-inner">
											<div class="carousel-item active">
												<img class="d-block w-100" src="<?= base_url(); ?>assets/foto_sekolah_tpa/<?= $foto1 ?>" alt="First slide">
											</div>
											...
											<div class="carousel-item">
												<img class="d-block w-100" src="<?= base_url(); ?>assets/foto_sekolah_tpa/<?= $i->foto ?>" alt="First slide">
											</div>
											<?php } ?>
										</div>
...
document
	...
	$.getJSON(base_url+"gis_sekolah_tpa/sekolah_tpa_json", function(data){
		$.each(data, function(i, field){
			...
			if (data[i].id_sekolah == <?= $id_sekolah; ?>) {

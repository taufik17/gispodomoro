...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/login/loginstyle.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/login/font/sanspro.css">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 col-sm-7" style="color: #fff;">
						<blockquote>
							<h1 style="color: #fff"><strong>GIS Podomoro </strong></h1>
							<p>Selamat Datang di Sistem Informasi Geografis Pekon Podomoro.</p>
							<p>Keakuratan data peta dapat berubah seiring waktu. <br>dengan GIS, informasi dapat dimanajemen secara dinamis.</p>
						  	<footer style="color: #fff">KKN Institut Teknologi Sumatera 2019</footer>
						</blockquote>
					</div>
					<div class="col-lg-4 col-md-4 col-md-offset-1 col-sm-5">
						...
						<div class="login-box">
						  <div class="form-title" id="latarbelakang">
						     <font color="white">
						      <h1><i class="glyphicon glyphicon-lock"></i>&nbsp; <b>GIS</b> Login</h1>
						     </font>
						  </div>
						  <!-- /.login-logo -->
						  <div class="form-body">
						   ...
						   <p>&nbsp</p>
						    <form method="POST" action="<?php echo base_url();?>login/getlogin" onsubmit="return cekform();">
						      <div class="form-group has-feedback">
						        <input type="text" name="username" id="username" class="form-control" placeholder="Pengguna" required>
...
<!-- /.login-box -->
<!-- jQuery 3 -->
<script src="<?php base_url() ?>assets/login/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php base_url() ?>assets/login/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="<?php base_url() ?>assets/login/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
